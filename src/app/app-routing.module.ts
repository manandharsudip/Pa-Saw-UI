...
import { AdminAuthGaurdService, CustomerAuthGaurdService } from './services/auth-guard.service';
...
const routes: Routes = [
  ...
  {
    path: '', canActivate: [CustomerAuthGaurdService],
    children: [
      { path: 'carts', component: CartComponent },
    ]
  },
  {
    path: '', canActivate: [AdminAuthGaurdService],
    children: [
